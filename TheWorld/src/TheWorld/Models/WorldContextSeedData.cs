...
namespace TheWorld.Models
{
    public class WorldContextSeedData
    {
        ...
        //When seeding/ adding a IdentityUser you can't just add it, .net makes it so you have to use UserManager as there are rules it needs to check so same user not added twice. 
        ...
        //with async use Task as you can't just wait for nothing
        public async Task EnsureSeedDataAsync()
        {
            if(await _userManager.FindByEmailAsync("rayzorgod@hotmail.com") == null)
            {
                //Add new user
                var newUser = new WorldUser()
                {
                    UserName = "RayBennett",
                    Email = "rayzorgod@hotmail.com"
                };
